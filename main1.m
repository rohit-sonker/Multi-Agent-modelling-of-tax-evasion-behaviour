...
%         for j=1:5
%             if t>0
%                 payer(i+j-1,4)= payer(i+j-1,4)*t*2.5;
%             end
%         end
%     end
   for i=1:10000
...
% EU = zeros(10000,1); % net income after paying
% for i =1:10000
%     I = payoff(i,2) * payoff(i,1); %income reported
%     EU(i) = (1-a)*(payer(i,1)-r*I) + a*(payer(i,1)-r*payer(i,1)-f*(r*payer(i,1)-r*I));
%     payoff_p(i) = EU(i) - (payer(i,1) - r*payer(i,1));
% end;
